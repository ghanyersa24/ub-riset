            ...
            <div class="col-md-8 offset-2">
                ...
                <form class="form-add" id="form-add">
                    <div class="form-group">
                        ...
                        <input id="add-nama" class="form-control" type="text" name="nama" value="" required>
                    </div>
                    <div class="form-group">
                        <label for="add-nama">Email</label>
                        <input id="add-nama" class="form-control" type="text" name="email" value="" required>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="add-nama">Password</label>
                                <input id="add-nama" class="form-control" type="password" name="password" value="" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="add-nama">Konfirmasi Password</label>
                                <input id="add-nama" class="form-control" type="password" name="password_confirm" value="" required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="add-identifier">NIM saat menjadi mahasiswa</label>
                    ...
                    <div class="form-group">
                        <label for="add-foto">Foto bukti kelulusan (Surat yudisium/KTA/Surat Keterangan Lulus)</label>
                        <input type="file" id="add-foto" name="foto" class="form-control">
                    </div>
        ...
        $('#form-add').validate({
            submitHandler: function(form) {
                $.ajax({
                    ...
                    data: $('#form-add').serialize() + "&is_update=false",
                                ...
                                swal({
                                    ...
                                    .then(password => {
                                        ...
                                        $.ajax({
                                            type: "POST",
                                            url: api + "account/register/email",
                                            data: $('#form-add').serialize() + "&is_update=true&password=" +
                                                password,
                                            success: function(response) {
                                                if (response.error) {
