...
<div class="main-sidebar sidebar-style-2">
	<aside id="sidebar-wrapper">
		...
		<ul class="sidebar-menu">
			...
			<!-- account -->
			<!-- Product -->
			<li class="<?php echo $segment == 'myproduct' || $segment == 'detail' || $segment == 'produk' || $segment == 'roadmap' || $segment == 'testing' || $segment == 'sertifikasi' || $segment == 'foto' || $segment == 'kegiatan' || $segment == 'inventor'|| $segment == 'perusahaan'|| $segment == 'bisnis'|| $segment == 'mitra' ? 'active' : ''; ?>"><a class="nav-link" href="<?php echo base_url(); ?>admin/myproduct"><i class="fas fa-fire"></i> <span>My Product</span></a></li>
			</li>
